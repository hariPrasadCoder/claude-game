...
<p align="center">
  <img src="docs/demo.gif" alt="claude-game demo — a terminal-styled menu pops up with Tic-Tac-Toe, Wordle, Snake, and Connect Four, then plays Wordle while the status bar shows Claude is working" />
</p>
